...
<table border="1">
    ...
    <tr>
        ...
        <td><a href="listaPeliculas?action=borrar" style="display: inline-block; padding: 5px 10px; background-color: #ff0000; color: #fff; text-decoration: none; border: none; border-radius: 5px;">Borrar</a></td>
    </tr>
